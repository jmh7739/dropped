    ...
    <div>
      ...
      {tab === "stay" && (
        <Placeholder
          icon="🏨"
          title="숙소 특가 준비중"
          desc="아고다·야놀자·마이리얼트립·호텔스컴바인 등 숙소 특가를 연동 중입니다. 링크프라이스 리얼핫딜 승인 후 실제 할인 숙소가 카드로 올라옵니다."
        />
      )}
      {tab === "deal" && (
        <Placeholder
          icon="🎢"
          title="여행딜(투어·티켓·액티비티) 준비중"
          desc="클룩·KKday·Go City 등 투어/입장권/액티비티 딜을 연동 중입니다. 디즈니랜드·유니버설 티켓 같은 여행딜이 곧 올라옵니다."
        />
      )}
    </div>
  );
